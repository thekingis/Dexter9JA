...
public class CornerBorderTextView extends androidx.appcompat.widget.AppCompatTextView {

    Path mPath;
    float borderRadius;

    public CornerBorderTextView(Context context) {
        super(context);
    }

    public CornerBorderTextView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setAttributes(attrs);
    }

    public CornerBorderTextView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
